...
module.exports.handleReply = async function ({ api, event, handleReply }) {
  ...
  const img = ["https://i.pinimg.com/originals/31/f4/20/31f4202cc64cf08caa9533a127e0188b.gif", "https://i.waifu.pics/HerWAtK.gif",
"https://i.waifu.pics/dNFH012.gif",
"https://i.waifu.pics/SWMEyvi.gif"
 ]
  var path = __dirname + "/cache/1.gif"
...
module.exports.run = async function({ api, event, args }) {
  ...
  const fs = require('fs-extra');
  const imgP = []
  const img = ["https://i.pinimg.com/originals/31/f4/20/31f4202cc64cf08caa9533a127e0188b.gif"
